...
class fs {
	 ...
	 * @author Christophe Goidin <christophe.goidin@ac-grenoble.fr>
	 * @version 1.1
	 * @copyright Christophe Goidin - septembre 2018
	 */
	public static function getContenuFichier($fichier, $id = null) {
		try {
		    // ===============================================================================================================
		    // on renvoie le contenu INTEGRAL du fichier
		    // ===============================================================================================================
		    if (is_null($id)) {
		        if (is_file($fichier)) {
		            ob_start();
		    ...
		    // ===============================================================================================================
		    // on renvoie seulement le contenu du fichier correspondant au bloc dont l'id vaut $id 
		    // ===============================================================================================================
		    }else {
