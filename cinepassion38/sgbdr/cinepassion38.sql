...
CREATE TABLE pays (
	numPays								TINYINT UNSIGNED AUTO_INCREMENT			COMMENT "Le numéro du pays",
 	...
 	nationaliteHomme					VARCHAR(30)								COMMENT "La nationalité Homme",
 	nationaliteFemme					VARCHAR(30)								COMMENT "La nationalité Femme",
...
-- ===============================================================================================================
INSERT INTO pays (libellePays, nationaliteHomme, nationaliteFemme) VALUES 
	("Pays-Bas", "hollandais", "hollandaise"),
	("Afrique du sud", "africain", "africaine"),
	...
	("Nouvelle-Zelande", "néozélandais", "néozélandaise"),
	("Porto Rico", "portoricain", "portoricaine"),
	("Portugal", "portuguais", "portuguaise"),
	("Suede", "suédois", "suédoise"),
...
-- ===============================================================================================================
--   cr�ation de la table rsa permettant de stocker les couples de cl�s rsa (priv�es/publiques)                                
-- ===============================================================================================================
CREATE TABLE rsa (
	numKeyRsa							TINYINT UNSIGNED AUTO_INCREMENT							COMMENT "Le num�ro du couple de cl�s",
	tailleKeyRsa						SMALLINT UNSIGNED NOT NULL								COMMENT "Le nombre de bits de la cl� : 128, 256, 512, 1024, 2048 ou 4096",
	privateKeyRsa						VARCHAR(3300) NOT NULL									COMMENT "La cl� priv�e RSA",
  	publicKeyRsa						VARCHAR(850) NOT NULL									COMMENT "La cl� publique RSA",
	CONSTRAINT PK_RSA					PRIMARY KEY (numKeyRsa)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;

-- ===============================================================================================================
--   insertion des couples de cl�s rsa (priv�es/publiques)
-- ===============================================================================================================
...
CREATE TABLE typeUser (
	numTypeUser							TINYINT UNSIGNED AUTO_INCREMENT							COMMENT "Le num�ro du type d'utilisateur",
	libelleTypeUser						ENUM("administrateur", "membre", "visiteur") NOT NULL	COMMENT "Le libell� du type d'utilisateur",
	CONSTRAINT PK_TypeUser				PRIMARY KEY (numTypeUser)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;

CREATE TABLE user (
	loginUser							VARCHAR(20)												COMMENT "Le login de l'utilisateur",
	motDePasseUser						VARCHAR(128) NOT NULL									COMMENT "Le mot de passe chiffr� de l'utilisateur � l'aide de l'algorithme SHA2 512bits",
	prenomUser							VARCHAR(20) NOT NULL									COMMENT "Le pr�nom de l'utilisateur",
	...
	adresseUser							VARCHAR(30)												COMMENT "L'adresse de l'utilisateur : Num�ro de la voie, type de la voie et libell� de la voie",
	codePostalUser						VARCHAR(5)												COMMENT "Le code postal de l'utilisateur",
	villeUser							VARCHAR(20)												COMMENT "Le libell� de la ville de l'utilisateur",
	telephoneFixeUser					VARCHAR(10)												COMMENT "Le num�ro de t�l�phone fixe de l'utilisateur",
	telephonePortableUser				VARCHAR(10)												COMMENT "Le num�ro de t�l�phone portable de l'utilisateur",
	mailUser							VARCHAR(40) NOT NULL									COMMENT "L'adresse �lectronique de l'utilisateur",
	...
	nbEchecConnexionUser				TINYINT UNSIGNED DEFAULT 0 NOT NULL						COMMENT "Le nombre d'�checs de connexion de l'utilisateur",
	dateHeureCreationUser				DATETIME NOT NULL										COMMENT "La date et l'heure de la cr�ation de l'utilisateur",
	dateHeureDerniereConnexionUser		DATETIME												COMMENT "La date et l'heure de la derni�re connexion de l'utilisateur",
	typeUser							TINYINT UNSIGNED NOT NULL								COMMENT "Le num�ro du type d'utilisateur",
...
-- ============================================================================
--   modification du d�limiter
-- ============================================================================
DELIMITER //

-- ============================================================================
--   proc�dure stock�e permettant l'ajout des utilisateurs
-- ============================================================================
...
-- ============================================================================
--   repositionnement du d�limiteur � sa valeur initiale
-- ============================================================================
DELIMITER ;
...
CALL ajoutUser("membre",		"x05",		@defautMotDePasse, "Alonzo",	"Toilette",			"1989-05-10", "H", "10 rue des pens�es",		"38000", "Grenoble",			"0423203032", "0688223344", "x05@free.fr", 					"logan");
...
CALL ajoutUser("membre",		"x08",		@defautMotDePasse, "Am�d�e",	"Lunettepourlire",	"1978-11-22", "H", "14 avenue des fleurs",		"38420", "Domene",				"0430243037", "0661223114", "x08@netcourrier.com", 			"erreurNormalement!");
...
CALL ajoutUser("membre",		"x10",		@defautMotDePasse, "Ang�le",	"Labha",			"1985-10-28", "F", "15 all�e des poux",			"75000", "Paris",				"0150783544", "0685223366", "x10@yahoo.com", 				"shadowCat");
...
CALL ajoutUser("membre",		"x12",		@defautMotDePasse, "Anne-Laure","Ondanse",			"1999-09-29", "F", "11 all�e de l'empire",		"38190", "Villard-Bonnot",		"0455874458", "0610223315", "x12@yahoo.com", 				"spiderWoman");
...
CALL ajoutUser("membre",		"x17",		@defautMotDePasse, "Armelle",	"Lapendulaleur",	"1989-05-23", "F", "15 av fran�ois Mitterrand", "38190", "Villard-Bonnot",		"0420256560", "0647223555", "x17@cegetel.net", 				"araignee");
...
CALL ajoutUser("membre",		"x20",		@defautMotDePasse, "Benny",		"Soitil",			"1984-03-27", "H", "50 all�e de la Chine",		"38000", "Grenoble",			"0424555455", "0681223488", "x20@yahoo.com", 				"crabe");
CALL ajoutUser("membre",		"x21",		@defautMotDePasse, "Cali",		"Fourchon",			"1989-05-30", "H", "20 av du g�n�ral Leclerc",	"38190", "Villard-Bonnot",		"0427744551", "0641823344", "x21@netcourrier.com", 			"crocodile");
...
CALL ajoutUser("membre",		"x23",		@defautMotDePasse, "C�sar",		"Ienne",			"1989-05-02", "H", "54 all�e des cartouches",	"38190", "Villard-Bonnot",		"0428756984", "0623623344", "x23@yahoo.com", 				"hippopotame");
CALL ajoutUser("membre",		"x24",		@defautMotDePasse, "Chris",		"Ent�me",			"1979-07-30", "H", "17 rue Maupassant",			"75002", "Paris",				"0154874452", "0687723344", "x24@yahoo.com", 				"mouton");
CALL ajoutUser("membre",		"x25",		@defautMotDePasse, "Claire",	"Voyant",			"1989-05-20", "F", "14 rue des �les",			"75001", "Paris",				"0125656544", "0644423344", "x25@yahoo.com", 				"pingouin");
CALL ajoutUser("membre",		"x26",		@defautMotDePasse, "Daisy",		"Rable",			"1992-02-17", "F", "02 chemin des gla�ons",		"38190", "Villard-Bonnot",		"0420774587", "0611265144", "x26@yahoo.com", 				"poulet");
...
CALL ajoutUser("membre",		"x29",		@defautMotDePasse, "Emma",		"Touf�cela",		"1985-05-27", "F", "18 rue du soleil ",			"62100", "Calais",				"0321554445", "0671205544", "x29@yahoo.com", 				"zombie1");
...
CALL ajoutUser("visiteur",		"x32",		@defautMotDePasse, "Henri",		"Gole",				"1979-10-05", "H", "15 all�e des ploucs",		"75000", "Paris",				"0152211452", "0617652344", "x32@free.fr", 					"?");
CALL ajoutUser("visiteur",		"x33",		@defautMotDePasse, "Ines",		"T�tic",			"1978-05-04", "F", "19 chemin des anges",		"38000", "Grenoble",			"0498774447", "0731328745", "x33@yahoo.com", 				"?");
CALL ajoutUser("visiteur",		"x34",		@defautMotDePasse, "Jade",		"Orlapizza",		"1989-05-27", "F", "17 all�e du diable",		"06000", "Nice",				"0422110001", "0614288346", "x34@free.fr", 					"?");
...
CALL ajoutUser("visiteur",		"x38",		@defautMotDePasse, "Jerry",		"Tm�ladanse",		"1980-02-20", "H", "21 rue des montagnes",		"74000", "Annecy",				"0499652144", "0661223477", "x38@yahoo.com", 				"?");
...
CALL ajoutUser("visiteur",		"x44",		@defautMotDePasse, "Laurie",	"Kul�re",			"1975-12-27", "F", "18 avenue du coeur",		"59000", "Lille",				"0321554128", "0681223666", "x44@yahoo.com", 				"?");
...
CALL ajoutUser("visiteur",		"x49",		@defautMotDePasse, "M�d�",		"Capote",			"1979-04-10", "H", "44 rue des mimosas",		"73000", "Chambery",			"0422594524", "0655221598", "x49@gmail.com", 				"?");
CALL ajoutUser("visiteur",		"x50",		@defautMotDePasse, "M�lanie",	"Maldanlacage",		"1981-05-27", "F", "17 avenue Mermoz",			"73000", "Chambery",			"0491947854", "0666223206", "x50@yahoo.fr", 				"?");
...
CALL ajoutUser("visiteur",		"x54",		@defautMotDePasse, "Olga",		"Tokil�bon",		"1989-01-24", "F", "17 bd des melons",			"62100", "Calais",				"0312105445", "6112265870", "x54@cegetel.net", 				"?");
CALL ajoutUser("visiteur",		"x55",		@defautMotDePasse, "Pat",		"R�loin",			"1984-05-27", "H", "10 rue des cerises",		"38190", "Villard-Bonnot",		"0420203030", "0601224215", "x55@gmail.com", 				"?");
...
CALL ajoutUser("visiteur",		"x58",		@defautMotDePasse, "R�mi",		"Sion",				"1979-08-14", "H", "14 rue des courgettes",		"38190", "Villard-Bonnot",		"0454954214", "0641478521", "x58@gmail.com", 				"?");
